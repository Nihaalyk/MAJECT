...
import { StatusConnectedIcon, StatusDisconnectedIcon } from "../icons/SvgIcons";
...
export default function SidePanel() {
  ...
  const filterOptions = [
    ...
    { value: "tools", label: t("tool_use") },
    { value: "flow", label: language === "en" ? "Conversation Flow" : "Aliran Perbualan" },
